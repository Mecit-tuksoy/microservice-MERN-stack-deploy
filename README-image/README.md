...
![alt text](grafana-prometheus-url-test--1.png)
![alt text](grafana-dashboard-import-1.png)
![alt text](grafana-1860-dashboard-1.png)
![alt text](grafana-dashboard-son-1.png)
...
![alt text](pipeline7-1.png)
![alt text](pipeline9-1.png)

![alt text](uygulama-sayfa1-1.png)
![alt text](uygulama-sayfa2-1.png)
![alt text](uygulama-sayfa3-1.png)
![alt text](uygulama-sayfa4-1.png)

### EKS metrikleri takip ediliyor mu?
...
![alt text](graf-email1-1.png)

````sh
sudo systemctl restart grafana-server
````
![alt text](graf-email2-1.png)
![alt text](graf-email3-1.png)
![alt text](graf-email4-1.png)
![alt text](graf-email5.png-1.jpg)
![alt text](graf-email6-1.png)
![alt text](graf-email7-1.png)
